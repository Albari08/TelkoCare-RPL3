...
class AntrianController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('rafly.pasien.antrian-pasien', compact('groupedAntrians', 'latestAntrianSatu', 'latestAntrianDua', 'today', 'tanggal'));
    }
    ...
    public function show($id, Request $request)
    {
        ...
        return view('rafly.pasien.antrian-pasien-detail', compact('antriandetail', 'groupedAntrians', 'latestAntrianSatu', 'latestAntrianDua', 'today', 'tanggal'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return redirect()->route('pasien.antrian')->with('success', 'Antrian berhasil ditambah');
    }
