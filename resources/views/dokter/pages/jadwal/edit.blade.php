            ...
            <form method="POST" action="{{ route('dokter.jadwal.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <select
                        ...
                        <option @selected($item->hari === 'Senin') value="Senin">Senin</option>
                        <option @selected($item->hari === 'Selasa') value="Selasa">Selasa</option>
                        <option @selected($item->hari === 'Rabu') value="Rabu">Rabu</option>
                        <option @selected($item->hari === 'Kamis') value="Kamis">Kamis</option>
                        <option @selected($item->hari === 'Jumat') value="Jumat">Jumat</option>
                        <option @selected($item->hari === 'Sabtu') value="Sabtu">Sabtu</option>
                        <option @selected($item->hari === 'Minggu') value="Minggu">Minggu</option>
                    </select>
                    @error('hari')
                ...
                <div class="mb-4">
                    ...
                    <input type="time" id="jam_buka" name="jam_buka" value="{{ $item->jam_buka ?? old('jam_buka') }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="time" id="jam_tutup" name="jam_tutup" value="{{ $item->jam_tutup ?? old('jam_tutup') }}"
