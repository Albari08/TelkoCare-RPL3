    ...
    <div class="flex-1 p-5">
        ...
        <div class="mt-5">
            ...
            <div class="shadow-xl mt-5 min-h-96">
                ...
                <form action="{{ route('resepPasien.update', $resep->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="w-full mt-16 flex justify-end">
                        <select class="w-50 mr-3 border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-1 focus:ring-blue-500" name="store">
                            <option value="">Select Store</option>
                            <option value="Medical Store 1">Medical Store 1</option>
                            <option value="Medical Store 2">Medical Store 2</option>
                            <option value="Medical Store 3">Medical Store 3</option>
                        </select>
                    </div>
                    ...
                    <div class="w-full mt-5">
                        ...
                        <a href="{{ route('resepPasien.index') }}" class="right-0 float-right mx-5 px-8 bg-gray-400 text-white text-sm py-2 justify-center items-center rounded-xl cursor-pointer z-10">
                            Close
                        </a>
                    </div>
                </form>
