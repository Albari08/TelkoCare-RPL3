    ...
    <section>
        <div class="px-2 lg:px-10 mb-4 border-b border-[#FFF5F5] dark:border-gray-700">
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-styled-tab"
                ...
                <li class="me-2" role="presentation">
                    <button class="inline-block p-2 rounded-t-lg" id="detail-styled-tab" data-tabs-target="#styled-detail"
        ...
        <div id="default-styled-tab-content">
                    ...
                    <div class="flex-col" style="width: 70%;">
                        ...
                        <form action="{{ route('pasien.antrian.create') }}" method="POST">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-20 mb-10">
                                <label for="loket1" class="flex items-center bg-[#D8D8D8] rounded-xl">
                                    <input type="radio" name="loket" id="loket1" value="1">
                                ...
                                <label for="loket2" class="flex items-center bg-[#D8D8D8] rounded-xl">
                                    <input type="radio" name="loket" id="loket2" value="2">
            ...
            <div class="hidden" id="styled-detail" role="tabpanel" aria-labelledby="detail-tab">
                    ...
                    <form action="">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="number" name="loket" id="loket"
                                class="text-sm p-2 rounded-xl border-[#FF0000] w-full block"
                                value="{{ $antriandetail->loket }}" placeholder="Silahkan Masukkan Loket" disabled>
                        </div>
                    </form>
                </div>
            </div>
