        ...
        <div class="mt-5">
            ...
            <div class="shadow-xl mt-5 min-h-96">
                ...
                <div class="w-full mt-16">
                    <a href="{{ route('resep.index') }}" class="right-0 float-right mx-5 px-8 bg-gray-400 text-white text-sm py-2  justify-center items-center rounded-xl cursor-pointer z-10">
                        Close
                    </a>
                </div>
            </div>
