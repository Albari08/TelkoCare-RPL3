...
<body class="bg-white font-family-karla flex">
    ...
    <div class="flex-1 p-5">
        ...
        @endif
        <h1 class="font-bold text-4xl text-gray-600">Apoteker</h1>
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td class="px-4 py-2 border border-gray-700 border-l-0 rounded-tr-lg rounded-br-lg text-center">
                      <a href="{{ route('apoteker.edit', $row->id )}}" class="bg-red-500 text-white px-4 py-1 rounded-xl text-sm text-center">Rincian</a>
                    </td>
                </tr>
                @endforeach
              </tbody>
