    ...
    <section>
        <div class="px-10 mb-4 border-b border-[#FFF5F5] dark:border-gray-700">
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-styled-tab">
                ...
                <li class="me-2" role="presentation">
                    <button class="cursor-default inline-block p-2 rounded-t-lg text-[#FF0000]/50 border-b border-[#FFF5F5]">Detail</button>
                </li>
            </ul>
        </div>
        <div class=" w-[90%] mx-auto">
            <div class="mb-5" x-data="{ open: true }">
                <div class="mb-3 flex justify-between items-center">
                    <p class="text-base font-bold">Jumat, 06 Oktober 2023</p>
                    <button @click="open = ! open">
                        <svg :class="open ? 'rotate-180' : ''" class="fill-[#0F0833] hover:fill-[#0F0833]/50 duration-500 w-4" viewBox="0 0 16 9"
                ...
                <div x-show="open" class="flex flex-row justify-between gap-4 p-6 bg-white border rounded-lg">
                    <div class="flex-col w-[92%]">
                        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 flex-col">
                            <div>
                                <p class="text-[12px] text-[#717375]">11:35 WIB</p>
                                <p class="font-semibold">Azka Noor Hafizh</p>
                            </div>
                            <div>
                    ...
                    <div class="flex-col w-[8%]">
                        <div class="flex justify-end">
                            <a href="/rafly/antrian-admin-detail">
                                <svg class="w-8 fill-[#FF2020] hover:fill-[#FF2020]/50 duration-300" viewBox="0 0 34 31"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
