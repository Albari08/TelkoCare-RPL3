...
const HideButtonIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg preserveAspectRatio='none' viewBox='0 0 32 32' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    <g filter='url(#filter0_d_63_2451)'>
    ...
    <defs>
      ...
      >
        ...
        <feBlend mode='normal' in2='BackgroundImageFix' result='effect1_dropShadow_63_2451' />
        <feBlend mode='normal' in='SourceGraphic' in2='effect1_dropShadow_63_2451' result='shape' />
      </filter>
    </defs>
  </svg>
);
